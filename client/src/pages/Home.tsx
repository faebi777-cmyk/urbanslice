...
const MENU_DATA = {
  ...
  streetFood: [
    ...
    { name: 'BURGER URBAN BLACK ANGUS', image: IMAGE_URLS.margherita, sizes: { 'standard': { price: 50, weight: '350 g' } }, ingredients: 'Chiflă burger, burger Black Angus România, sos Urban, cheddar, mozzarella, castraveți murați, salată, bacon, ceapă - Include cartofi prăjiți cu parmezan' },
    { name: 'BURGER CRISPY', image: IMAGE_URLS.margherita, sizes: { 'standard': { price: 45, weight: '350 g' } }, ingredients: 'Chiflă burger, 120 g pui crispy, sos Urban, cheddar, mozzarella, castraveți murați, salată, bacon, ceapă - Include cartofi prăjiți cu parmezan' },
  ],
  garnituri: [
  ...
  alcoholicBeverages: [
    ...
    { name: 'Budureasca Clasic - 0.75 ml', image: IMAGE_URLS.margherita, sizes: { 'standard': { price: 70, weight: '' } }, ingredients: '' },
    { name: 'Compas - 0.75 ml', image: IMAGE_URLS.margherita, sizes: { 'standard': { price: 65, weight: '' } }, ingredients: '' },

...
const IMAGE_URLS = {
  ...
  margherita: '/poze ai urban slice/poza pizza margherita.png',
  vegetariana: '/poze ai urban slice/poza pizza vegetariana.png',
  capricciosa: '/poze ai urban slice/poza capriciosa.png',
  prosciuttoFunghi: '/poze ai urban slice/poza prosciutto e funghi.png',
  quattroFormaggi: '/poze ai urban slice/poza quatro formaggi.png',
  ...
  zucchini: '/poze ai urban slice/poza zucchini.png',
  ...
  mirinda: '/mirinda.png',
  lipton: '/lipton.png',
  apaPlata: '/apa-plata.png',
  apaMinerala: '/apa-minerala.png',
  limonada: '/limonada.png',
  limonadaArome: '/limonada-arome.png',
  ceai: '/ceai.png',
...
const MENU_DATA = {
  pizzaClassica: [
    ...
    { name: 'COTTO', image: IMAGE_URLS.cotto, sizes: { '32cm': { price: 42, weight: '600 g' }, '40cm': { price: 65, weight: '700 g' } }, ingredients: 'Palina, sos de roșii, mozzarella, șuncă' },
  ...
  beverages: [
    ...
    { name: 'Cappuccino', image: IMAGE_URLS.cappuccino, sizes: { '200ml': { price: 15, weight: '200 ml' } }, ingredients: '' },
  ],
};
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {currentMenu.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    {showImage && (
                      <div className={`relative h-32 overflow-hidden flex items-center justify-center ${activeCategory === 'beverages' ? 'bg-black' : 'bg-gray-800'}`}>
                        <img src={item.image} alt={item.name} className={`hover:scale-110 transition-transform duration-300 ${activeCategory === 'beverages' ? 'max-h-full max-w-full object-contain p-2' : 'w-full h-full object-cover'}`} style={{ imageRendering: 'auto', filter: 'contrast(1.05) brightness(1.02)' }} loading="lazy" />
                      </div>
                    )}
                    <div className="p-3">

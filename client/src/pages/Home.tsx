...
const IMAGE_URLS = {
  ...
  pepsi: '/poza pepsi.png',
  mirinda: '/poza mirinda.png',
  lipton: '/poza lipton.png',
  apaPlata: '/poza apa plata.png',
  apaMinerala: '/poza apa minerala.png',
  limonada: '/poza limonada.png',
  limonadaArome: '/poza limonada arome.png',
  ceai: '/poza ceai.png',
  espresso: '/poza espresso.png',
  latte: '/poza latte.png',
  cappuccino: '/poza cappuccino.png',
};
